...
export function BrandMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      role="img"
      aria-label="Curtis Image Studio logo"
      {...props}
    >
      <defs>
        <linearGradient id="curtis-coral" x1="18" y1="16" x2="78" y2="82" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FFB39D" />
          <stop offset="0.48" stopColor="#E98068" />
          <stop offset="1" stopColor="#C95749" />
        </linearGradient>
        <linearGradient id="curtis-glow" x1="20" y1="18" x2="78" y2="80" gradientUnits="userSpaceOnUse">
      ...
      <path d="M78 15v16M70 23h16" stroke="#D6F2E8" strokeWidth="1.5" strokeLinecap="round" opacity="0.8" />
    </svg>
  );
}